...
Page({
     ...
     * 获取订单列表
     */
    getRechargeList: function(dataType) {
        let _this = this;
        App._get('user.recharge/lists', {
            dataType
        }, function(result) {
            ...
            success: function(o) {
                if (o.confirm) {
                    App._post_form('user.recharge/cancel', {
                        ...
                        _this.getRechargeList(_this.data.dataType);
                    });
                }
            }
        });
    ...
    bindHeaderTap: function(e) {
        ...
        // 获取订单列表
        this.getRechargeList(e.target.dataset.type);
    },
