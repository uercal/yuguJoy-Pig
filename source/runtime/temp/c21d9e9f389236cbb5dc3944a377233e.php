<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"F:\demo\yuguJoy-pig\web/../source/application/store\view\privilege\index.php";i:1542274790;s:68:"F:\demo\yuguJoy-pig\source\application\store\view\layouts\layout.php";i:1542093361;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()) : foreach ($list as $item) : ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle"><?= $item['privilege_name'] ?></td>
                                    <td class="am-text-middle"><?= $item['url'] ?></td>                                                               
                                    <!-- <td class="am-text-middle"><?= $item['api_menu_id'] ?></td> -->
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= url('member/privilege_edit',
                                                ['id' => $item['id']]) ?>">
...
<script>
    $(function () {
        // 删除元素
        var url = "<?= url('member/privilege_delete') ?>";
