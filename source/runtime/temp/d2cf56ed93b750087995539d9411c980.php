<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"F:\demo\yuguJoy-pig\web/../source/application/store\view\member\add.php";i:1540362615;s:68:"F:\demo\yuguJoy-pig\source\application\store\view\layouts\layout.php";i:1539228309;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="member[role_id]" required
                                        ...
                                        <?php if (isset($role_list)): foreach ($role_list as $first): ?>
                                            <option value="<?= $first['id'] ?>"><?= $first['role_name'] ?></option>                                            
