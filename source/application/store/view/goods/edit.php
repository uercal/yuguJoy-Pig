                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="goods[goods_name]" value="<?= $model['goods_name'] ?>" maxlength="40" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="goods[category_id]" required data-am-selected="{searchBox: 1, btnSize: 'sm',  placeholder:'请选择产品分类'}">
                                        ...
                                        <option value="<?= $first['category_id'] ?>" <?= $model['category_id'] === $first['category_id'] ? 'selected' : '' ?>>
                                            <?= $first['name'] ?></option>
                                        <?php if (isset($first['child'])) : foreach ($first['child'] as $two) : ?>
                                        <option value="<?= $two['category_id'] ?>" <?= $model['category_id'] === $two['category_id'] ? 'selected' : '' ?>>
                                            　　<?= $two['name'] ?></option>
                                        <?php if (isset($two['child'])) : foreach ($two['child'] as $three) : ?>
                                        <option value="<?= $three['category_id'] ?>" <?= $model['category_id'] === $three['category_id'] ? 'selected' : '' ?>>
                                            　　　<?= $three['name'] ?></option>
                                        <?php endforeach;
                                endif; ?>
                                        <?php endforeach;
                                    ...
                                    <div class="am-form-file">
                                        ...
                                        <div class="uploader-list am-cf">
                                            ...
                                            <div class="file-item">
                                                ...
                                                <input type="hidden" name="goods[images][]" value="<?= $item['image_id'] ?>">
                            ...
                            <!-- 服务多规格 -->
                            <div class="goods-spec-many am-form-group" style="display: <?= $model['spec_type'] === 20 ? 'block' : 'none' ?>;">
                            ...
                            <!-- 产品单规格 -->
                            <div class="goods-spec-single" style="display: <?= $model['spec_type'] === 10 ? 'block' : 'none' ?>;">

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">产品价格 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="number" class="tpl-form-input" name="goods[spec][goods_price]" value="<?= $model['spec'][0]['goods_price'] ?>" required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">当前库存数量 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="number" class="tpl-form-input" name="goods[spec][stock_num]" value="<?= $model['spec'][0]['stock_num'] ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group" style="display:none;">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[deduct_stock_type]" value="10" data-am-ucheck <?= $model['deduct_stock_type'] === 10 ? 'checked' : '' ?>>
                                        下单减库存
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[deduct_stock_type]" value="20" data-am-ucheck <?= $model['deduct_stock_type'] === 20 ? 'checked' : '' ?>>
                                        付款减库存
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[goods_status]" value="10" data-am-ucheck <?= $model['goods_status']['value'] === 10 ? 'checked' : '' ?>>
                                        上架
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[goods_status]" value="20" data-am-ucheck <?= $model['goods_status']['value'] === 20 ? 'checked' : '' ?>>
                                        下架
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <label class="am-checkbox">
                                        <input type="checkbox" name="goods[service][]" value="<?= $item['service_id'] ?>" data-am-ucheck <?= $item['selected'] ? 'checked' : '' ?>><?= $item['service_name'] ?>
                                    </label>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[sales_initial]" value="<?= $model['sales_initial'] ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">产品排序 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[goods_sort]" value="<?= $model['goods_sort'] ?>" required>
                                    <small>数字越小越靠前</small>
                                </div>
                            </div>
                            <div class="am-form-group">
