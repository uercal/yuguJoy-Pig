<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"F:\demo\yuguJoy-pig\web/../source/application/store\view\order\edit.php";i:1542077971;s:68:"F:\demo\yuguJoy-pig\source\application\store\view\layouts\layout.php";i:1542093361;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    ...
                                    <td style="width:10%;">
                                        <div class="rent-num-div am-input-group am-input-group-sm" order-goods-id="<?= $goods['order_goods_id'] ?>">      
                                            ...
                                            <?php else : if (!isset(json_decode($goods['rent_mode']['map'], true)[0]['max'])) : ?>
                                                ...
                                                <span style="color:#777;font-size:12px;"><?= $goods['rent_mode']['rent_show_unit'] ?></span>
                                            <?php else : if (json_decode($goods['rent_mode']['map'], true)[0]['min'] == json_decode($goods['rent_mode']['map'], true)[0]['max']) : ?>
