<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\demo\yuguJoy-pig\web/../source/application/store\view\exam\detail.php";i:1541034119;s:68:"F:\demo\yuguJoy-pig\source\application\store\view\layouts\layout.php";i:1541745694;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="widget-body">
                    <fieldset>
                        <form id="my-form" class="am-form tpl-form-line-form" method="post">
                            ...
                            <?php foreach ($data as $key => $item) : if ($key == 'input') : foreach ($item as $k => $v) : ?>
                                    ...
                                    <?php endforeach; elseif ($key == "image") : foreach ($item as $k => $v) : ?>
                                        <div class="am-form-group">
                                            <label class="am-u-sm-3 am-u-lg-2 am-form-label"> <?= $map[$k] ?> :</label>
                                            <div class="am-u-sm-9 am-u-end">                                                
