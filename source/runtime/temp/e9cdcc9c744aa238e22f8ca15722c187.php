<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"F:\demo\yuguJoy-pig\web/../source/application/store\view\goods\service.php";i:1541466629;s:68:"F:\demo\yuguJoy-pig\source\application\store\view\layouts\layout.php";i:1542093361;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-cf">产品服务</div>
                </div>
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <p class="item-title"><?= $item['service_name'] ?></p>
                                    </td>
                                    <td class="am-text-middle"><?= $item['service_price'] ?></td>
                                    <td class="am-text-middle"><?= $item['create_time'] ?></td>                                                                    
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= url('goods/service_edit',
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= url('goods/service_delete') ?>";
        $('.item-delete').delete('service_id', url);
