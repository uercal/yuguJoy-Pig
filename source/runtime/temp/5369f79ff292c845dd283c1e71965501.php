<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"F:\demo\yuguJoy-pig\web/../source/application/store\view\privilege\add.php";i:1542275494;s:68:"F:\demo\yuguJoy-pig\source\application\store\view\layouts\layout.php";i:1542093361;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <label class="am-checkbox-inline">                                            
                                            <input type="checkbox"  value="<?= $item['index'] ?>" name="privilege[api_menu_id][]" data-am-ucheck><?= $item['name'] ?>
                                        </label>
                                        <?php else : foreach($item['submenu'] as $sub):if(isset($sub['index'])): ?>
                                        <label class="am-checkbox-inline">
                                            <input type="checkbox" value="<?= $sub['index'] ?>" name="privilege[api_menu_id][]" data-am-ucheck><?= $sub['name'] ?>
                                        </label>
                                        <?php else: foreach($sub['submenu'] as $c):?>
                                            <label class="am-checkbox-inline">
                                                <input type="checkbox" value="<?= $c['index'] ?>" name="privilege[api_menu_id][]" data-am-ucheck><?= $c['name'] ?>
                                            </label>
