<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"F:\demo\yuguJoy-pig\web/../source/application/store\view\role\edit.php";i:1540361506;s:68:"F:\demo\yuguJoy-pig\source\application\store\view\layouts\layout.php";i:1542093361;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="role[role_name]"
                                           value="<?= $model['role_name'] ?>" required>
                                </div>
                            </div>
