                        ...
                        <div class="am-form-group">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs" style="display:flex;">
                                    ...
                                    <select name="equip_status" id="check_status" style="font-size:12px;" data-am-selected="{btnWidth: '40%', btnSize: 'xs'}">
                                        <option value="0">不限</option>
                                        <option value="10" <?php if (isset($map['equip_status']) && $map['equip_status'] == 10) : ?> selected <?php endif; ?>>在库</option>
                                        <option value="20" <?php if (isset($map['equip_status']) && $map['equip_status'] == 20) : ?> selected <?php endif; ?>>运送中</option>
                                        <option value="30" <?php if (isset($map['equip_status']) && $map['equip_status'] == 30) : ?> selected <?php endif; ?>>使用中</option>
                                        <option value="40" <?php if (isset($map['equip_status']) && $map['equip_status'] == 40) : ?> selected <?php endif; ?>>维修中</option>
                                        <option value="50" <?php if (isset($map['equip_status']) && $map['equip_status'] == 30) : ?> selected <?php endif; ?>>停用</option>
