...
Page({
    ...
    getRentDetail: function() {
        ...
        App._get('rent/getList', {
            ...
            console.log(res);
            let index = 0;
            let _default = res.find(function(e, i) {
                index = i;
                return e.is_default == 1;
            });
            console.log([index, _default]);
            _this.setData({
                // rent_index: 0,
                // rent_list: res,
                // rentInfo: res[0],
                // rent_limit: res[0].rent_limit,
                // rent_num: res[0].rent_num
                rent_index: index,
                rent_list: res,
                rentInfo: _default,
                rent_limit: _default.rent_limit,
                rent_num: _default.rent_num
            });
            _this.rentPrice(_default.rent_num, _default);
        });
    },

    chooseRent: function(e) {
        let index = e.currentTarget.dataset.index;
        this.data.rent_num = this.data.rent_list[index].rent_num;
        this.data.rent_limit = this.data.rent_list[index].rent_limit;
        this.setData({
            rent_index: index,
    ...
    chooseRentNum: function(e) {
        ...
        this.rentPrice(num, this.data.rentInfo);
    },
